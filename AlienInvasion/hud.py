"""
Provides HUD Class for Alien Invasion game.

HUD Class manages and updates the current score, high score, max score, 
...
class HUD: 
    """Class for HUD for game"""
    def __init__(self, game):
        """Initializes the score, life images, and level"""
        self.game = game
    ...
    def _setup_life_image(self):
        """Sets up the images for each life"""
    ...
    def update_scores(self):
        """Updates all scores on HUD"""
        self._update_max_score()
        self._update_score()
        self._update_hi_score()
        
    def _update_score(self):
        """Manages position for the score on HUD"""
    ...
    def _update_max_score(self):
        """Manages position for max score"""
    ...
    def update_level(self):
        """Manages position for current level"""
    ...
    def _draw_lives(self):
        """"Draws the amount of lives on screen"""
